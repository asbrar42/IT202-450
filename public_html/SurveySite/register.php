		...
		elseif($password == $cpassword){
			...
			try{
				...
				if($e[0] != "00000"){
					...
					echo "<div>Successfully registered! Redirecting to Login page in 3 seconds...</div>";
					header("refresh:3; url=https://it202sample.herokuapp.com/public_html/SurveySite/login.php");
				}
			}				
			catch (Exception $e){
				echo $e->getMessage();
